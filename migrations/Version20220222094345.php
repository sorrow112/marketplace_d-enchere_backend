 ...
 */
final class Version20220222094345 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD birth_date DATETIME DEFAULT NULL, CHANGE user_name display_name VARCHAR(20) NOT NULL');
    }
