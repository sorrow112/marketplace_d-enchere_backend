 ...
 */
final class Version20220322113209 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enchere DROP current_price');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enchere ADD current_price DOUBLE PRECISION NOT NULL');
