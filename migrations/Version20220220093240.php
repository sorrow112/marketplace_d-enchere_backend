 ...
 */
final class Version20220220093240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD birth_date DATETIME DEFAULT NULL');
    }
